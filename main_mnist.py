...
flags.DEFINE_integer("output_size_row", 28 , "the size of generate image")
flags.DEFINE_integer("output_size_col", 28 , "the size of generate image")
...
flags.DEFINE_string("model_path" , "model_mnist/model.ckpt" , "the path of model")
